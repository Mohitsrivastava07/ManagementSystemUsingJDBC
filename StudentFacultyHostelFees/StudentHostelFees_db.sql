...
create table studentshostelfees (
...
alter table studentshostelfees modify column address varchar(355) not null after phone_number;

-- adding the room_number after address column
alter table studentshostelfees add column room_number varchar(4) not null after address;

-- changes the phone_number data type
alter table studentshostelfees modify phone_number varchar(10) not null;

-- retrieve the table
select * from studentshostelfees;
